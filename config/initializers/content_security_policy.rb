Rails.application.config.content_security_policy do |policy|
  ...
  policy.connect_src :self, "wss://*.crisp.chat", "*.crisp.chat", "*.#{FR_SITE}", "in-automate.sendinblue.com", "app.franceconnect.gouv.fr", "sentry.io", "geo.api.gouv.fr", "api-adresse.data.gouv.fr"
