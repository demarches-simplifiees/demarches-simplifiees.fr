Rails.application.config.content_security_policy do |policy|
  ...
  # Whitelist image
  policy.img_src :self, :data, "*.openstreetmap.org", "static.demarches-simplifiees.fr", "*.cloud.ovh.net", "stats.data.gouv.fr", "*.crisp.chat"
  # Whitelist JS: nous, sendinblue et matomo
  # miniprofiler et nous avons quelques boutons inline :(
  policy.script_src :self, "stats.data.gouv.fr", "*.sendinblue.com", "*.crisp.chat", :unsafe_eval, :unsafe_inline
  ...
  policy.style_src :self, :unsafe_inline, "*.crisp.chat"
