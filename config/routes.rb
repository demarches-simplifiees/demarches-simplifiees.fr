...
Rails.application.routes.draw do
  ...
  namespace :france_connect do
    ...
    get 'particulier/choose_email' => 'particulier#choose_email', as: :particulier_choose_email
    get 'particulier/email_field', to: 'particulier#email_field', as: :turbo_frame_email_field
    get 'confirm_email/:token', to: 'particulier#confirm_email', as: :confirm_email
    get 'connect_france_connect_particulier_redirect/:user_id', to: 'particulier#connect_france_connect_particulier_redirect', as: :connect_france_connect_particulier_redirect
