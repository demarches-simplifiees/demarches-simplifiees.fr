...
demarche.numerique.gouv.fr is [free software](https://en.wikipedia.org/wiki/Free_software). You can read and modify its source code under the terms of the AGPL license.

If you would like to make improvements to demarche.numerique.gouv.fr, it's possible!

The best way is to **propose a modification to the main codebase**. Once accepted, your improvement will be available to all users of demarche.numerique.gouv.fr.
...
To do this, [create a new issue](https://github.com/demarche-numerique/demarche.numerique.gouv.fr/issues/new) about your proposal. As much as possible, clearly state your need, your use case - and potentially how you already think about solving it.

We can then discuss to verify that the expressed need aligns with the purpose of demarche.numerique.gouv.fr, possibly suggest alternatives, and agree on a relevant technical implementation.

## 2. Propose code

Once the discussion is established and the technical elements are outlined, you can propose code changes. To do this, make your modifications locally and [open a Pull Request](https://github.com/demarche-numerique/demarche.numerique.gouv.fr/issues/new) with the changes you want to make.
...
We deploy to production at least once a week (and usually more often): your changes will be available in production on [demarche.numerique.gouv.fr](https://demarche.numerique.gouv.fr) within a few days.

## Hosting demarche.numerique.gouv.fr

demarche.numerique.gouv.fr is **complicated to host**. Among the issues we face:

- **Data security and confidentiality**: by nature, demarche.numerique.gouv.fr is designed to process various types of data that may have more or less sensitive characteristics. The security of the infrastructure must be controlled and certified to guarantee data confidentiality. This involves, for example, a process of compliance with the [General Security Framework](https://www.ssi.gouv.fr/entreprise/reglementation/confiance-numerique/le-referentiel-general-de-securite-rgs/) (Référentiel Général de Sécurité), which is quite a heavy process.
  ...
  The encryption of attachments is provided by our HTTP proxy : [DS Proxy](https://github.com/demarche-numerique/ds_proxy), but it's optional.

- **Use of external services**: demarche.numerique.gouv.fr interconnects with many external services: APIs (API Entreprise, API Carto, the National Address Database, etc.) - but also services for external storage of attachments, anti-virus analysis, or sending emails. The operation of demarche.numerique.gouv.fr depends on the availability of these external services.
...
If you want to adapt demarche.numerique.gouv.fr to your needs, we recommend **proposing your modifications to the main codebase** (for example by creating an issue) **rather than hosting another instance yourself**.

If you are considering hosting an instance of demarche.numerique.gouv.fr yourself, unfortunately, we do not have the resources to assist you or provide technical support for your installation.
