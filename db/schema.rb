...
ActiveRecord::Schema[7.0].define(version: 2025_03_20_153834) do
  ...
  create_table "dossier_notifications", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["dossier_id", "notification_type", "instructeur_id", "groupe_instructeur_id"], name: "dossier_notifications_index", unique: true, where: "((instructeur_id IS NULL) AND (groupe_instructeur_id IS NULL))"
