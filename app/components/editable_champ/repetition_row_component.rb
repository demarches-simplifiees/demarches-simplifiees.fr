...
class EditableChamp::RepetitionRowComponent < ApplicationComponent
  ...
  def section_component
    EditableChamp::SectionComponent.new(dossier: @dossier, types_de_champ: @types_de_champ, row_id:, row_number: has_fieldset? ? nil : @row_number, input_labelled_by_prefix: has_fieldset? ? fieldset_legend_id : parent_fieldset_legend_id)
  end
end
