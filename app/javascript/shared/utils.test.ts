...
suite('@utils', () => {
  ...
  suite('formatDecimal', () => {
    ...
    test('getting a Canadian (English and French) format', () => {
      const stringValue = '4 294 967 295,050';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a Danish format', () => {
      const stringValue = '4 294 967 295,050';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a Finnish format', () => {
      const stringValue = '4 294 967 295,050';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a French format', () => {
      const stringValue = '4 294 967 295,050';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a German format', () => {
      const stringValue = '4 294 967.295,050';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a Italian format', () => {
      const stringValue = '4.294.967.295,050';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a Norwegian format', () => {
      const stringValue = '4.294.967.295,050';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a Spanish format', () => {
      const stringValue = '4.294.967.295,050';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a Swedish format', () => {
      const stringValue = '4 294 967 295,050';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a GB-English format', () => {
      const stringValue = '4,294,967,295.05';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a US-English format', () => {
      const stringValue = '4,294,967,295.05';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('getting a Thai format', () => {
      const stringValue = '4,294,967,295.05';
      expect(formatDecimal(stringValue)).toEqual(expectedFloat);
    });

    test('partial with .', () => {
      const stringValue = '295.';
      expect(formatDecimal(stringValue)).toEqual(stringValue);
    });
