...
const MapReader = ({ geoData }) => {
  ...
  if (!mapboxgl.supported()) {
    return (
      <p>
        La carte n'est pas compatible avec votre navigateur. Afin de l'afficher,
        nous vous conseillons de le mettre à jour ou d'en utiliser un plus
        moderne (Chrome, Firefox ou Safari)
      </p>
    );
  }
