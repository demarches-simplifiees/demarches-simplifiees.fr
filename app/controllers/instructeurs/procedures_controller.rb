...
module Instructeurs
  class ProceduresController < InstructeurController
    ...
    def index
      ...
      @procedures_en_cours = publiees_or_closes_with_dossiers_en_cours.order_by_position_for(current_instructeur)
      ...
      @procedures_draft = all_procedures_for_listing.brouillons
