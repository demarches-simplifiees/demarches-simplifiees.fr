...
module Users
  class DossiersController < UserController
    ...
    def dossier_params
      params.require(:dossier).permit(:for_tiers, :mandataire_first_name, :mandataire_last_name, individual_attributes: [:nom, :prenom, :birthdate, :email, :notification_method])
    end
