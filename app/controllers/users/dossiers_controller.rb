  ...
  class DossiersController < UserController
    ...
    def attestation
      if dossier.attestation&.pdf&.attached?
        ...
        flash.notice = I18n.t('controllers.users.dossier_controller.not_available_certificate')
    ...
    def update_identite
      ...
      if @dossier.individual.update(individual_params)
        ...
        flash.notice = I18n.t('controllers.users.dossier_controller.id_data_registred_flashnotice')
    ...
    def etablissement
      ...
      if !@dossier.etablissement
        flash.alert = I18n.t('controllers.users.dossier_controller.establishment_tied_to_flashalert')
    ...
    def update_brouillon
      ...
      if passage_en_construction? && errors.blank?
        ...
        flash.now.notice = I18n.t('controllers.users.dossier_controller.saved_draft_flashnownotice')
      end
    ...
    def extend_conservation
      ...
      flash[:notice] = I18n.t('controllers.users.dossier_controller.file_longer_archived_flashnownotice')
      redirect_to dossier_path(@dossier)
    end
    ...
    def create_commentaire
      ...
      if @commentaire.save
        ...
        flash.notice = I18n.t('controllers.users.dossier_controller.message_send_flashnotice')
    ...
    def ask_deletion
      ...
      if dossier.can_be_deleted_by_user?
        ...
        flash.notice = I18n.t('controllers.users.dossier_controller.file_deleted_flashalert')
        redirect_to dossiers_path
      else
        flash.notice = I18n.t('controllers.users.dossier_controller.undergoingreview_flashnotice')
        redirect_to dossier_path(dossier)
      end
    end
    ...
    def show_demarche_en_test_banner
      if @dossier.present? && @dossier.procedure.brouillon?
        flash.now.alert = I18n.t('controllers.users.dossier_controller.test_procedure_flashnowalert')
      end
    end

    def ensure_dossier_can_be_updated
      if !dossier.can_be_updated_by_user?
        flash.alert = I18n.t('controllers.users.dossier_controller.no_longer_edit_file_flashalert')
        redirect_to dossiers_path
      end
    end
    ...
    def forbidden!
      flash[:alert] = I18n.t('controllers.users.dossier_controller.have_not_access_file_flashalert')
