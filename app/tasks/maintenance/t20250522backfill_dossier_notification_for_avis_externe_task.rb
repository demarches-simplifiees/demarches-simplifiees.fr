...
module Maintenance
  class T20250522backfillDossierNotificationForAvisExterneTask < MaintenanceTasks::Task
    # Documentation: cette tâche permet de créer les DossierNotification manquantes
    # de type 'AVIS EXTERNE'
    ...
    def collection
      Follow
        ...
        .joins(:dossier)
        .where("dossiers.last_avis_updated_at > follows.avis_seen_at")
    ...
    def process(follow)
      ...
      DossierNotification.find_or_create_by!(
        ...
        notification_type: :avis_externe,
