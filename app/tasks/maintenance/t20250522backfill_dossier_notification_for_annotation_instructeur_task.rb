...
module Maintenance
  class T20250522backfillDossierNotificationForAnnotationInstructeurTask < MaintenanceTasks::Task
    # Documentation: cette tâche permet de créer les DossierNotification manquantes
    # de type 'ANNOTATION INSTRUCTEUR'
    ...
    def collection
      Follow
        ...
        .joins(:dossier)
        .where("dossiers.last_champ_private_updated_at > follows.annotations_privees_seen_at")
    ...
    def process(follow)
      DossierNotification.find_or_create_by!(
        ...
        notification_type: :annotation_instructeur,
