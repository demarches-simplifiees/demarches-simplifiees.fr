class TypeDeChamp < ApplicationRecord
  ...
  TYPE_DE_CHAMP_TO_CATEGORIE = {
    ...
    pays: LOCALISATION,
    epci: LOCALISATION,
    numbers_id: PAIEMENT_IDENTIFICATION,
    numbers_and_letters_id: PAIEMENT_IDENTIFICATION,
  ...
  enum type_champs: {
    ...
    numbers_and_letters_id: 'numbers_and_letters_id',
    iban: 'iban',
    siret: 'siret',
    text: 'text',
    textarea: 'textarea',
  ...
  def prefillable?
    type_champ.in?([
      ...
      TypeDeChamp.type_champs.fetch(:numbers_id),
