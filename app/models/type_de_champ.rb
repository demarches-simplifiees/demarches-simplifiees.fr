class TypeDeChamp < ApplicationRecord
  ...
  delegate :estimated_fill_duration, :estimated_read_duration, :tags_for_template, :libelles_for_export, :libelle_for_export, :libelle_for_path, :paths_for_export, :primary_options, :secondary_options, to: :dynamic_type
