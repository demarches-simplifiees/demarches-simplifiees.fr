...
class Dossier < ApplicationRecord
  ...
  def close_to_expiration?
    ...
    expired_at - Expired::REMAINING_WEEKS_BEFORE_EXPIRATION.weeks < Time.zone.now && Time.zone.now < expired_at
  end
  ...
  def has_expired?
    ...
    notice_sent_at + Expired::REMAINING_WEEKS_BEFORE_EXPIRATION.weeks < Time.zone.now
  end
