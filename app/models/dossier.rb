...
class Dossier < ApplicationRecord
  ...
  def show_groupe_instructeur_details?
    procedure.routing_enabled? && groupe_instructeur.present? && (!procedure.feature_enabled?(:procedure_routage_api) || !defaut_groupe_instructeur?) && !procedure.feature_enabled?(:routing_logic)
  end
