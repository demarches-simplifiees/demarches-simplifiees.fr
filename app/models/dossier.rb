class Dossier < ApplicationRecord
  ...
  has_many :champs_public, -> { root.public_ordered }, class_name: 'Champ', inverse_of: false, validate: false
  has_many :champs_private, -> { root.private_ordered }, class_name: 'Champ', inverse_of: false, validate: false
