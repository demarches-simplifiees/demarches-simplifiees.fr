...
class ProcedureRevisionTypeDeChamp < ApplicationRecord
  ...
  delegate :stable_id, :libelle, :description, :type_champ, :header_section_level_value, :header_section?, :explication?, :repetition?, :mandatory?, :public?, :private?, :to_typed_id, to: :type_de_champ
