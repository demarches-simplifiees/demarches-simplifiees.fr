...
class BatchOperation < ApplicationRecord
  enum :operation, {
    ...
    create_multiple_commentaire: 'create_multiple_commentaire'
  }
  ...
  def dossiers_safe_scope(dossier_ids = self.dossier_ids)
    ...
    when BatchOperation.operations.fetch(:create_multiple_commentaire) then
  ...
  def process_one(dossier)
    ...
    when BatchOperation.operations.fetch(:create_multiple_commentaire)
