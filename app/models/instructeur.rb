class Instructeur < ApplicationRecord
  ...
  def procedure_presentation_and_errors_for_groupe_instructeur_id(groupe_instructeur_id)
    assign_to.find_by(groupe_instructeur_id: groupe_instructeur_id).procedure_presentation_or_default_and_errors
  end
