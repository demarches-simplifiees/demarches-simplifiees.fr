...
class TypesDeChamp::TypeDeChampBase
  ...
  delegate :description, :libelle, :mandatory, :mandatory?, :stable_id, :fillable?, :public?, :type_champ, :options_for_select, :drop_down_options, :referentiel_drop_down_options, :drop_down_other?, to: :@type_de_champ
