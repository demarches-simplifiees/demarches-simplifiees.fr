...
class Procedure < ApplicationRecord
  ...
  scope :with_active_revision, -> { includes(draft_revision: [:types_de_champ, revision_types_de_champ: [:type_de_champ]], published_revision: [:types_de_champ, revision_types_de_champ: [:type_de_champ]]) }
