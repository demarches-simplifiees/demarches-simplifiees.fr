class Procedure < ActiveRecord::Base
  ...
  def initiated_mail_template
    initiated_mail || Mails::InitiatedMail.default_for(self)
  end

  def received_mail_template
    received_mail || Mails::ReceivedMail.default_for(self)
  end

  def closed_mail_template
    closed_mail || Mails::ClosedMail.default_for(self)
  end

  def refused_mail_template
    refused_mail || Mails::RefusedMail.default_for(self)
  end

  def without_continuation_mail_template
    without_continuation_mail || Mails::WithoutContinuationMail.default_for(self)
  end
