...
class DossierTree
  ...
  def initialize(coordinates:, procedure:, dossier: nil, stream: nil, profile: nil)
  ...
  def types_de_champ(coordinates)
    ...
    coordinates.each do |coordinate|
      ...
      if repetition.present? && !coordinate.parent&.repetition?
        # close repetition
      ...
      if ancestor.present?
        coordinate.parent = ancestor[:coordinate]
      end
