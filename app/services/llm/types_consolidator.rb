  ...
  class TypesConsolidator < BaseImprover
    ...
    def schema_prompt
      <<~TXT
        ...
        - siret : Numéro SIRET. Fournit automatiquement via API Entreprise : raison sociale, SIREN, nom commercial, forme juridique, code NAF, libellé d'activité, N° TVA intracommunautaire, capital social, effectif, date de création, adresse du siège, état administratif. Pour les associations : RNA, titre, objet, dates.
    ...
    def rules_prompt
      <<~TXT
        ...
        Les types address et siret fournissent automatiquement de nombreuses informations.
        ...
        Exemple : "Adresse de résidence" + "Commune de résidence" → address + destroy commune
