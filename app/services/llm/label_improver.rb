...
module LLM
  ...
  class LabelImprover < BaseImprover
        ...
        parameters: {
          ...
          properties: {
            update: {
              ...
              required: %w[stable_id libelle position],
            },
    ...
    def build_item(args)
      ...
      return if filter_invalid_llm_result(stable_id, libelle, description)

      {
        op_kind: 'update',
        stable_id: stable_id,
        payload: { 'stable_id' => stable_id, 'libelle' => libelle, 'description' => description, 'position' => position }.compact,
        safety: 'safe',
