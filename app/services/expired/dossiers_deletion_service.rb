...
class Expired::DossiersDeletionService < Expired::MailRateLimiter
  ...
  def update_notifications_dossiers_en_construction
    DossierNotification.create_notifications_for_non_customisable_type(Dossier.en_construction_close_to_expiration, :dossier_expirant)
  ...
  def update_notifications_dossiers_termine
    DossierNotification.create_notifications_for_non_customisable_type(Dossier.termine_close_to_expiration, :dossier_expirant)
