class PiecesJustificativesService
  ...
  def self.serialize_types_de_champ_as_type_pj(procedure_or_dossier)
    tdcs = procedure_or_dossier.is_a?(Dossier) ? procedure_or_dossier.types_de_champ : procedure_or_dossier.current_revision.types_de_champ
    tdcs = tdcs.filter { |type_champ| type_champ.old_pj.present? }
