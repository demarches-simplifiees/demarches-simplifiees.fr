...
class NotificationMailer < ApplicationMailer
  before_action :set_dossier, except: [:send_notification_for_tiers, :send_accuse_reception_notification]
  ...
  def send_accuse_reception_notification(dossier)
    @dossier = dossier
    ...
    mail(subject: @subject, to: @email, template_name: 'send_accuse_reception_notification')
  end
