...
class ProcedureDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    new_draft_mail_template: MailTemplateField,
    revert_to_construction_mail_template: MailTemplateField,
    revert_to_instruction_mail_template: MailTemplateField,
