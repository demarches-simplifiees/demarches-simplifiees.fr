namespace :after_party do
  desc 'Deployment task: auto_completion_migration'
  task auto_completion_migration: :environment do
    puts "Running deploy task 'auto_completion_migration'"
    ...
    Champ.where(type: Champs::AutoCompletionChamp.to_s).update_all(type: Champs::DropDownListChamp.to_s)
