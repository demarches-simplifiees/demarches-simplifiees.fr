namespace :after_party do
  desc 'Deployment task: create_variants_for_pjs_from_messagerie'
  task create_variants_for_pjs_from_messagerie: :environment do
    puts "Running deploy task 'create_variants_for_pjs_from_messagerie'"
