  ...
  RSpec.describe T20250611backfillDossiersExpiredAtTask do
    describe "#process" do
      ...
      context "when dossier is en brouillon" do
        let(:dossier) { create(:dossier, :brouillon, expired_at: nil) }
      ...
      context "when dossier is en construction" do
        let(:dossier) { create(:dossier, :en_construction, expired_at: nil) }
      ...
      context "when dossier is en instruction" do
        let(:dossier) { create(:dossier, :en_instruction, expired_at: nil) }
        it "raises an error" do
