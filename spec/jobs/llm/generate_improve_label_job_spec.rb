...
RSpec.describe LLM::GenerateImproveLabelJob, type: :job do
  ...
  context 'with suggestion' do
    ...
    it 'persists generated items and completes' do
      items = [
        { rule: 'improve_label', op_kind: 'update', stable_id: 1, payload: { 'stable_id' => 1, 'libelle' => 'Libellé 1' }, safety: 'safe' },
        { rule: 'improve_label', op_kind: 'update', stable_id: 2, payload: { 'stable_id' => 2, 'libelle' => 'Libellé 2' }, safety: 'safe' }
      ]
