  ...
  describe '#make_diff' do
    ...
    context 'with updated groupe instructeur' do
      ...
      it do
        ...
        expect(forked_dossier.user_draft_changes?).to be_truthy
      end
    end
    ...
    context 'with updated champ' do
      ...
      it 'user_draft_changes? should reflect dossier state' do
        expect(subject).to eq(added: [], updated: [updated_champ], removed: [])
        expect(dossier.user_draft_changes?).to be_truthy
        expect(forked_dossier.user_draft_changes?).to be_truthy
        expect(updated_champ.user_draft_changes?).to be_truthy
      end
    end
