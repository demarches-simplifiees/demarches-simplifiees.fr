  ...
  describe 'replace_tags' do
    ...
    context 'when the procedure has a type de champ repetition' do
      ...
      before do
        ...
        champ = paul_champs.first
        dossier.champ_for_update(champ.type_de_champ, champ.row_id, updated_by: 'test').update(value: 'Paul')
        champ = paul_champs.last
        dossier.champ_for_update(champ.type_de_champ, champ.row_id, updated_by: 'test').update(value: 'Chavard')

        champ = pierre_champs.first
        dossier.champ_for_update(champ.type_de_champ, champ.row_id, updated_by: 'test').update(value: 'Pierre')
        champ = pierre_champs.last
        dossier.champ_for_update(champ.type_de_champ, champ.row_id, updated_by: 'test').update(value: 'de La Morinerie')
      end
