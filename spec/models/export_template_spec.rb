describe ExportTemplate do
  ...
  describe 'new' do
    # let(:export_template) { ExportTemplate.new(groupe_instructeur: groupe_instructeur) }
  ...
  describe '#valid?' do
    ...
    let(:mention) { {"type"=>"mention", "attrs"=>{"id"=>"dossier_id", "label"=>"id dossier"}} }
    ...
    context 'with no ddd text' do
      ...
      context 'with mention' do
        let(:ddd_mention) { {"type"=>"mention", "attrs"=>{"id"=>"dossier_id", "label"=>"id dossier"}} }
        it 'has no error for default_dossier_directory' do
          expect(subject.valid?).to be_truthy
          expect(subject.errors[:default_dossier_directory]).not_to be_present
        end
