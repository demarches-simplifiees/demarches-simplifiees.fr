describe Dossier do
  ...
  describe "#delete_and_keep_track!" do
    ...
    subject! { dossier.delete_and_keep_track!(user, reason) }
  ...
  describe 'brouillon_expired and en_construction_expired' do
    ...
    before do
      ...
      create(:dossier, user: user).delete_and_keep_track!(user, reason)
      create(:dossier, :en_construction, user: user).delete_and_keep_track!(user, reason)
