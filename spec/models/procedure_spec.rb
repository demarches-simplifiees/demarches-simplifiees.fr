describe Procedure do
  describe 'mail templates' do
    ...
    it { expect(subject.nouveau_brouillon_mail_template).to be_a(Mails::NouveauBrouillonMail) }
    it { expect(subject.repasser_en_construction_mail_template).to be_a(Mails::RepasserEnConstructionMail) }
    it { expect(subject.repasser_en_instruction_mail_template).to be_a(Mails::RepasserEnInstructionMail) }
  end
