describe DescriptionsController, type: :controller do
  ...
  describe "#update" do
    ...
    context 'when adding a type_de_champ_id' do
      ...
      let(:params) { { type_de_champ_ids: [type_de_champ.id], type_de_champ_id_to_add: type_de_champ_to_add.id } }
    ...
    context 'when removing a type_de_champ_id' do
      ...
      let(:params) { { type_de_champ_ids: [type_de_champ.id], type_de_champ_id_to_remove: type_de_champ_to_remove.id } }
