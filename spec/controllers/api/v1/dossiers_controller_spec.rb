      ...
      describe 'dossiers' do
        ...
        describe 'dossier' do
          ...
          it do
            ...
            expect(subject[:updated_at]).to eq("2008-09-01T20:05:00.000Z")
            expect(subject[:initiated_at]).to eq("2008-09-01T19:56:00.000Z")
    ...
    context 'when procedure is found and belongs to current admin' do
      ...
      context 'when dossier exists and belongs to procedure' do
        ...
        it do
          expect(subject[:id]).to eq(dossier.id)
          expect(subject[:state]).to eq('closed')
          expect(subject[:created_at]).to eq('2008-09-01T19:55:00.000Z')
          expect(subject[:updated_at]).to eq('2008-09-01T20:05:00.000Z')
        ...
        describe 'commentaires' do
          ...
          it do
            ...
            expect(subject.first[:created_at]).to eq '2016-03-15T00:00:00.000Z'
