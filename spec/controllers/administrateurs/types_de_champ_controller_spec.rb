...
describe Administrateurs::TypesDeChampController, type: :controller do
  let(:procedure) do
    create(:procedure,
           types_de_champ_public: [
             ...
             { type: :multiple_drop_down_list, libelle: 'l4' }
           ],
  ...
  def fourth_coordinate = procedure.draft_revision.revision_types_de_champ_public.reload.fourth
  ...
  describe '#update' do
    ...
    context 'with a multiple dropdown list with a referentiel' do
      ...
      let(:multiple_drop_down_list_type_de_champ) do
        procedure.draft_revision.types_de_champ_public.fourth
      end

      let(:params) do
        {
          procedure_id: procedure.id,
          stable_id: fourth_coordinate.stable_id,
          referentiel_file:,
          name: referentiel_file.original_filename,
          type_de_champ: {
            libelle: 'updated'
