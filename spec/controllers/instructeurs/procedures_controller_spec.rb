    ...
    context "when logged in" do
      ...
      context "with procedures assigned" do
        ...
        it 'assigns procedures visible to the instructeur' do
          ...
          expect(assigns(:procedures_draft)).to include(procedure_draft)
          expect(assigns(:procedures_draft)).not_to include(procedure_draft_discarded)
          expect(assigns(:procedures_en_cours)).to include(procedure_published)
        end
      end
    end
  end
