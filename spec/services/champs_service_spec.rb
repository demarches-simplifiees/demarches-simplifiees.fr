...
describe ChampsService do
  ...
  let!(:champ) { create(:champ, value: 'toto', type_de_champ: type_de_champ) }
  let!(:champ_mandatory_empty) { create(:champ, type_de_champ: type_de_champ_mandatory) }
  let!(:champ_datetime) { create(:champ, type_de_champ: type_de_champ_datetime) }
