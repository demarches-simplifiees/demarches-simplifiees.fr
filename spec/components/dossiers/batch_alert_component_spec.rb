...
RSpec.describe Dossiers::BatchAlertComponent, type: :component do
  ...
  describe 'create multiple commentaire' do
    let(:component) do
      described_class.new(
        batch: batch_operation,
        procedure: procedure
    ...
    let!(:batch_operation) { create(:batch_operation, operation: :create_multiple_commentaire, dossiers: [dossier, dossier_2], instructeur: instructeur) }
