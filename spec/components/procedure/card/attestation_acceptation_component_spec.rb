...
RSpec.describe Procedure::Card::AttestationAcceptationComponent, type: :component do
  ...
  context "when version is 2" do
    ...
    context "when AttestationAcceptation is enabled" do
      ...
      it { is_expected.to have_css('h3.fr-h6', text: "Attestation d’acceptation") }
      it { is_expected.to have_link(href: component.helpers.edit_admin_procedure_attestation_template_v2_path(procedure, attestation_kind: :acceptation)) }
    end
