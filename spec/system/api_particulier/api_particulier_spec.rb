  ...
  context 'when a user is logged in' do
    ...
    context 'CNAF' do
      scenario 'it can fill an cnaf champ' do
        ...
        expect(page).to have_content(/Le champ « cnaf » le code postal doit posséder 5 caractères/)
    ...
    context 'DGFiP' do
      scenario 'it can fill a DGFiP field', vcr: { cassette_name: 'api_particulier/success/avis_imposition' } do
        ...
        click_on 'Déposer le dossier'
        expect(page).to have_content(/Le champ « dgfip » la référence d’avis d’imposition doit posséder 13 ou 14 caractères/)
