FactoryBot.define do
  ...
  factory :procedure do
    ...
    trait :with_paraphe do
      with_all_annotations

      after(:build) do |procedure, evaluator|
        (libelle, type_champ) = TypeDeChamp.type_champs.fetch(:paraphe)
        ...
        build(:type_de_champ_paraphe, procedure: procedure, private: true, libelle: 'paraphe_to_test', position: procedure.active_revision.types_de_champ.size, accredited_user_string: accredited_user_string)
        build(:type_de_champ_text, procedure: procedure, private: true, libelle: 'text_after_paraphe_to_test', position: procedure.active_revision.types_de_champ.size)
      end
    end
  end
end
