...
RSpec.describe DossierMailer, type: :mailer do
  ...
  describe '.notify_en_construction_near_deletion_to_instructeur' do
    let(:dossier) { create(:dossier) }
  ...
  describe '.notify_excuse_deletion_to_user' do
    ...
    subject { described_class.notify_excuse_deletion_to_user(dossier.user, [dossier.hash_for_deletion_mail]) }
